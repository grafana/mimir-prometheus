...
func (r blockIndexReader) InfoMetricDataLabels(ctx context.Context, lbls labels.Labels, t int64, matchers ...*labels.Matcher) (labels.Labels, annotations.Annotations, error) {
	return r.ir.InfoMetricDataLabels(ctx, lbls, t, matchers...)
}
