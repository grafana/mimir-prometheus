...
func (oh *OOOHeadIndexReader) InfoMetricDataLabels(context.Context, labels.Labels, int64, index.InfoMetricSampleQuerier, ...*labels.Matcher) (labels.Labels, annotations.Annotations, error) {
	// TODO
