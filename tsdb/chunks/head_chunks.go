...
// The returned chunk ref is the reference for where the chunk encoding starts for the chunk.
...
// Truncate deletes the head chunk files which file numbers are less than given fileNo.
