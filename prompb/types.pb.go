...
type TimeSeries struct {
	...
	// Identifying labels for info metrics.
	IdentifyingLabels    []string `protobuf:"bytes,5,rep,name=identifyingLabels,proto3" json:"identifyingLabels,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *TimeSeries) GetIdentifyingLabels() []string {
	if m != nil {
		return m.IdentifyingLabels
	}
	return nil
}
...
var fileDescriptor_d938547f84707355 = []byte{
	...
	,
}
...
func (m *TimeSeries) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.IdentifyingLabels) > 0 {
		for iNdEx := len(m.IdentifyingLabels) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.IdentifyingLabels[iNdEx])
			copy(dAtA[i:], m.IdentifyingLabels[iNdEx])
			i = encodeVarintTypes(dAtA, i, uint64(len(m.IdentifyingLabels[iNdEx])))
			i--
			dAtA[i] = 0x2a
		}
	}
...
func (m *TimeSeries) Size() (n int) {
	...
	if len(m.IdentifyingLabels) > 0 {
		for _, s := range m.IdentifyingLabels {
			l = len(s)
			n += 1 + l + sovTypes(uint64(l))
		}
	}
...
func (m *TimeSeries) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field IdentifyingLabels", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.IdentifyingLabels = append(m.IdentifyingLabels, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipTypes(dAtA[iNdEx:])
