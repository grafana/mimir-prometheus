...
var matcherTestCases = []struct {
	...
	{27, "route", MatchRegexp, "(prometheus|api_prom)_api_v1_.+"},
	...
	{31, "topic", MatchNotRegexp, "(.+)-KSTREAM-AGGREGATE-STATE-STORE-(.+)"},
	...
	{11, "job", MatchNotRegexp, ".*envoy-stats.*"},
	{11, "db_name", MatchNotRegexp, "template.*|^$"},
	{11, "exported_job", MatchNotRegexp, ".*envoy-stats.*"},
	...
	{8, "image_spec", MatchNotRegexp, "(.*):1364de3"},
	{8, "image_spec", MatchNotRegexp, "(.*):cfc5ca8"},
	{1.1, "namespace", MatchNotRegexp, "(ops-service-02)"},
	{1, "slug", MatchNotRegexp, "ephemeral.*"},
	{8, "image_spec", MatchNotRegexp, "(.*):d849bcd"},
	{8, "image_spec", MatchNotRegexp, "(.*):cb8eaaa"},
