...
func TestFanout_SelectSorted(t *testing.T) {
	...
	t.Run("querier", func(t *testing.T) {
		...
		seriesSet := querier.Select(context.Background(), true, nil, matcher)
	...
	t.Run("chunk querier", func(t *testing.T) {
		...
		seriesSet := storage.NewSeriesSetFromChunkSeriesSet(querier.Select(context.Background(), true, nil, matcher))
