...
func TestLabels_DropMetricName(t *testing.T) {
	...
	require.True(t, Equal(FromStrings("aaa", "111"), FromStrings(common.MetricName, "myname", "aaa", "111").DropMetricName()))

	original := FromStrings("__aaa__", "111", common.MetricName, "myname", "bbb", "222")
	check := original.Copy()
...
func TestLabels_DropReserved(t *testing.T) {
	shouldDropFn := func(n string) bool {
		return n == common.MetricName || n == "__something__"
	}
	require.True(t, Equal(FromStrings("aaa", "111", "bbb", "222"), FromStrings("aaa", "111", "bbb", "222").DropReserved(shouldDropFn)))
	require.True(t, Equal(FromStrings("aaa", "111"), FromStrings(common.MetricName, "myname", "aaa", "111").DropReserved(shouldDropFn)))
	require.True(t, Equal(FromStrings("aaa", "111"), FromStrings(common.MetricName, "myname", "__something__", string(model.MetricTypeCounter), "aaa", "111").DropReserved(shouldDropFn)))
...
// 	require.Equal(t, FromStrings(common.MetricName, "333", "aaa", "111").Bytes(nil), FromStrings(common.MetricName, "333", "aaa", "111", "bbb", "222").BytesWithoutLabels(nil, "bbb"))
// 	require.Equal(t, FromStrings("aaa", "111").Bytes(nil), FromStrings(common.MetricName, "333", "aaa", "111", "bbb", "222").BytesWithoutLabels(nil, common.MetricName, "bbb"))
// }
...
func TestBuilder(t *testing.T) {
	...
	for i, tcase := range []struct {
		...
		{
			base: EmptyLabels(),
			set:  []common.Label{{"aaa", "444"}, {"bbb", "555"}, {"ccc", "666"}},
		...
		{
			set:  []common.Label{{"aaa", "111"}, {"bbb", "222"}, {"ccc", "333"}},
			del:  []string{"bbb"},
			want: FromStrings("aaa", "111", "ccc", "333"),
		},
		{
			base: FromStrings("aaa", "111"),
			set:  []common.Label{{"bbb", "222"}},
			want: FromStrings("aaa", "111", "bbb", "222"),
		},
		{
			base: FromStrings("aaa", "111"),
			set:  []common.Label{{"bbb", "222"}, {"bbb", "333"}},
			want: FromStrings("aaa", "111", "bbb", "333"),
		},
		{
			base: FromStrings("aaa", "111", "bbb", "222", "ccc", "333"),
			del:  []string{"bbb"},
			set:  []common.Label{{"ddd", "444"}},
...
func TestScratchBuilder(t *testing.T) {
	for i, tcase := range []struct {
		...
		{
			add:  []common.Label{{"aaa", "111"}},
			want: FromStrings("aaa", "111"),
		},
		{
			add:  []common.Label{{"aaa", "111"}, {"bbb", "222"}, {"ccc", "333"}},
			want: FromStrings("aaa", "111", "bbb", "222", "ccc", "333"),
		},
		{
			add:  []common.Label{{"bbb", "222"}, {"aaa", "111"}, {"ccc", "333"}},
			want: FromStrings("aaa", "111", "bbb", "222", "ccc", "333"),
		},
		{
			add:  []common.Label{{"ddd", "444"}},
