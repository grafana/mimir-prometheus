...
| <code class="text-nowrap">--scrape.name-escaping-scheme</code> | method to escape legacy invalid names when sending to an old version of prometheus.  can be one of values (default), underscores, dots, or allow-utf-8 | `values` |
